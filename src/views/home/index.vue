...
export default defineComponent({
  ...
  computed: {
    ...mapState('drive', ['taskExpiresIn', 'feedbackVisible', 'treeData', 'treeDataVisible']),
    ...mapState('user', ['userInfo', 'curUser']),
    tabId () {
      return this.$store.state.drive.currentTabId;
    },
    space() {
      return this.$store.state.drive.files.space;
    },
    parent_id() {
    ...
    files() {
      return this.$store.state.drive.files.list;
    },
    hasMore() {
      return this.$store.state.drive.files.hasMore;
    },
    hasLogin() {
